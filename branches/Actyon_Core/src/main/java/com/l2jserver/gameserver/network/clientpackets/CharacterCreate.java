...
public final class CharacterCreate extends L2GameClientPacket
{
	...
	private void initNewChar(L2GameClient client, L2PcInstance newChar)
	{
		...
		/*
		 * Añaimos la localización para cuando se crea el personaje Faction.
		 **/
		if (Config.FACTION_SYSTEM_ENABLED)
		{
			newChar.setXYZInvisible(Config.SPAWN_X_FACTION_STARTING_LOCATION, Config.SPAWN_Y_FACTION_STARTING_LOCATION, Config.SPAWN_Z_FACTION_STARTING_LOCATION);
		}
		else
		{
