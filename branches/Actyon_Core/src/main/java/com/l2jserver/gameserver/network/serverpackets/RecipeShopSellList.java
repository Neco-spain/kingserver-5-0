...
public class RecipeShopSellList extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		{
			// zeus -----------------------------------------------------------------------------------------
			if (ZeuS.isPremium(_manufacturer))
			{
				_buyer.sendMessage("The Player " + _manufacturer.getName() + " has a Premium System (Name: " + ZeuS.getPremiumName(_manufacturer) + ") , and you will get "
					+ String.valueOf(ZeuS.getCraftChance(_manufacturer) + "% more over the Craft Chance and " + String.valueOf(ZeuS.getMW_CraftChance(_manufacturer)) + "% over on Masterwork (rare) Chance."));
			}
			// -----------------------------------------------------------------------------------------------
