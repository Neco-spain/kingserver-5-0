...
public class FactionManager extends AbstractNpcAI
{
	...
	private FactionManager()
	{
		...
		Location locManager = new Location(Config.SPAWN_X_FACTION_MANAGER_LOCATION, Config.SPAWN_Y_FACTION_MANAGER_LOCATION, Config.SPAWN_Z_FACTION_MANAGER_LOCATION, Config.SPAWN_H_FACTION_MANAGER_LOCATION);
		if (Config.FACTION_SYSTEM_ENABLED)
		{
			addSpawn(MANAGER, locManager, false, 0);
		}
	}
	...
	{
		Location locGood = new Location(Config.SPAWN_X_FACTION_GOOD_BASE_LOCATION, Config.SPAWN_Y_FACTION_GOOD_BASE_LOCATION, Config.SPAWN_Z_FACTION_GOOD_BASE_LOCATION);
		Location locEvil = new Location(Config.SPAWN_X_FACTION_EVIL_BASE_LOCATION, Config.SPAWN_Y_FACTION_EVIL_BASE_LOCATION, Config.SPAWN_Z_FACTION_EVIL_BASE_LOCATION);
		switch (event)
		{
